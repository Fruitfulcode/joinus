<div class="ff-settings-options-form ff-joinus-settings-form" id="subscribe-notification-container">

	<div class="frtfl-modal__content">
		<h2><?php _e( 'Fruitful Code statistic', 'joinus' ); ?></h2>
		<p class="description">
			<?php _e( 'We would be happy if you assist us in becoming better. Share your site statistic to help us
                        ...
                        newsletters for the latest updates!', 'joinus' ); ?>
		</p>
		<div class="form-group">
			<label>
				...
				<?php _e( 'Send configuration information to Fruitful Code to help to improve this plugin', 'joinus' ) ?>
			</label>
		</div>
		...
		<div class="form-group" id="modal-ffc-subscribe__wrapper">
			<label>
				...
				<?php _e( 'Subscribe to the Fruitful Code newsletters', 'joinus' ) ?>
			</label>
			...
			<div class="frtfl-modal__content_user-info <?php if($ffc_subscribe === 0) { _e( 'hidden'); }?>" id="frtfl-modal__content_user-info">
				<div class="floating-placeholder__wrapper subscribe__input_name">
					<input type="text" placeholder="Name" name="ffc_subscribe_name" required <?php if( $ffc_subscribe !== 1) { _e( 'disabled'); }?>  value="<?php _e( $ffc_name ); ?>">
					<label><?php _e( 'Name', 'joinus' ); ?>*</label>
				</div>
				<div class="floating-placeholder__wrapper subscribe__input_email">
					<input type="email" placeholder="E-mail" name="ffc_subscribe_email"  required <?php if( $ffc_subscribe !== 1) { _e( 'disabled'); }?> value="<?php _e( $ffc_email ); ?>">
					<label><?php _e( 'E-mail', 'joinus' ); ?>*</label>
				</div>
			</div>
		</div>
