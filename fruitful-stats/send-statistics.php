...
class ffc_joinus_stats
{
	...
	public function ffc_build_stats_info_array($ffc_statistic, $ffc_subscribe, $ffc_email, $ffc_name, $is_theme = true) {
		...
		if( $is_theme ) {
			...
			$path = plugin_dir_path( __FILE__ ).'/../joinus.php';
	...
	public function ffc_check_stats() {
		...
		$ffc_joinus_stat_sent = get_transient( 'ffc_joinus_stat_sent' );

		if ( empty( $ffc_joinus_stat_sent ) ) {
			set_transient( 'ffc_joinus_stat_sent', '1', 1728000 ); //1728000 = 3600 * 24 * 20
