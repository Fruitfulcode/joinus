...
class ffc_joinus_stats_option
{
	...
	public function __construct()
	{
		...
		add_action( 'ff_joinus_display_settings_page', array( $this, 'ffc_display_admin_settings' ) );

		// Add action save plugin settings to update ffc stat option
		add_action( 'fruitful_joinus_plugin_setting_save', array( $this, 'ffc_update_stat_option_on_save_plugin_settings' ) );
	}
