...
class FruitfulJoinUsApp {

	public $product_type = 'plugin'; //{theme|plugin}

	public $product_option_name = 'joinus_options';
	...
	public function dispatch() {
		...
		$this->controller->statistic = new JoinUs_Stats( $this->root_file, $this->product_type, $this->product_option_name );
		...
		$this->controller->advertising = new JoinUs_Adv( $this->root_file, $this->product_type );
